 ...
 * 
 *  - Файл ordersData.json (по пути: C:\Users\Didar1520\Docks\CRM\data\OrdersData\ordersData.json) 
 ...
 *      }
 * 
 *  - Файл adressList.JSON (по пути: C:\Users\Didar1520\Docks\CRM\data\adressBook\adressList.JSON) 
...
// Вместо ordersConfig.js теперь используем config.js (см. структуру проекта).
// Путь: находимся в "scripts/actions/utils", значит к "scripts/config.js" - две директории вверх.
